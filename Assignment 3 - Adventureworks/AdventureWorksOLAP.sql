...
1 - For DW , attributes are easily visible. 
2 - For DW , one fact tables links to multiple dimension table. Easy to query
3 - DW tables has more columns than AdventureWorks
