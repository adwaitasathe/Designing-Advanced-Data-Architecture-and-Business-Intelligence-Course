...
CREATE TABLE DimGeography(
    GeographyKey_SK             int             IDENTITY(1,1),
    ...
    SalesTerritoryKey_SK        int             NOT NULL,
    CONSTRAINT PK_DimGeography_GeographyKey PRIMARY KEY NONCLUSTERED (GeographyKey_SK)
)
go
...
CREATE TABLE DimSalesTerritory(
    SalesTerritoryKey_SK     int               IDENTITY(1,1),
    TerritoryKey             int               NOT NULL,
    SalesTerritoryRegion     nvarchar(50)      NOT NULL,
    SalesTerritoryCountry    nvarchar(50)      NOT NULL,
    SalesTerritoryGroup      nvarchar(50)      NULL,
    SalesTerritoryImage      varbinary(max)    NULL,
    CONSTRAINT PK_DimSalesTerritory_SalesTerritoryKey PRIMARY KEY NONCLUSTERED (SalesTerritoryKey_SK)
)
go
...
ALTER TABLE DimEmployee ADD CONSTRAINT RefDimGeography41 
...
ALTER TABLE DimGeography ADD CONSTRAINT RefDimSalesTerritory44 
    FOREIGN KEY (SalesTerritoryKey_SK)
    REFERENCES DimSalesTerritory(SalesTerritoryKey_SK)
go
...
ALTER TABLE DimVendor ADD CONSTRAINT RefDimSalesTerritory40 
    FOREIGN KEY (SalesTerritoryKey_SK)
    REFERENCES DimSalesTerritory(SalesTerritoryKey_SK)
go
...
ALTER TABLE FactPurchase ADD CONSTRAINT RefDimSalesTerritory43 
    FOREIGN KEY (SalesTerritoryKey_SK)
    REFERENCES DimSalesTerritory(SalesTerritoryKey_SK)
go
